...
public class setupdoc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setupdoc);
    ...
    private void SaveData() {
        ...
        if(username.isEmpty() || username.length()<4){
            ...
            Toast.makeText(setupdoc.this,"Please Select an Image", Toast.LENGTH_SHORT).show();
                    ...
                    if(task.isSuccessful()){
                        StorageRef.child(mUser.getUid()).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                mRef.child("Doctor").child(mUser.getUid()).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener() {
                                    @Override
                                    public void onSuccess(Object o) {
                                        Intent intent = new Intent(setupdoc.this, activity_homedoc.class);
                                        startActivity(intent);
                                        mLoadingBar.dismiss();
                                        Toast.makeText(setupdoc.this,"Profile Completed", Toast.LENGTH_SHORT).show();
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        mLoadingBar.dismiss();
                                        Toast.makeText(setupdoc.this,e.toString(), Toast.LENGTH_SHORT).show();
