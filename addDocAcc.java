...
public class addDocAcc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_doc_acc);
...
//        });
    ...
    private void perfAuth() {
        ...
        if(TextUtils.isEmpty(emailad) && TextUtils.isEmpty(passw) && TextUtils.isEmpty(conpass)){
            Toast.makeText(addDocAcc.this, "Please fill up all fields.", Toast.LENGTH_SHORT).show();
        }
        ...
        else if(!emailad.matches(emailPattern)){
            ...
            mAuth.createUserWithEmailAndPassword(emailad, passw).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(addDocAcc.this,"Registration Successful", Toast.LENGTH_SHORT).show();
                        openSetup();
                    }
                    else{
                        progressDialog.dismiss();
                        Toast.makeText(addDocAcc.this,""+task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    {
        Intent register = new Intent(this, setupdoc.class);
