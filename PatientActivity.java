    ...
    private void LoadPatients(String s) {
        ...
        adapter = new FirebaseRecyclerAdapter<Patients, PatientviewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull PatientviewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull Patients model) {
                ...
                String agePatient = model.getAge().toString();
                String key= getRef(position).getKey().toString();

                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(PatientActivity.this, diagnosisList.class);
                        intent.putExtra("OtherUserID", key);
                        startActivity(intent);
//                        Intent i = new Intent(PatientActivity.this, reportmodule.class);
//                        i.putExtra("patientAge", agePatient);
//                        startActivity(i);
